                ...
                <div class="bg-primary rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            ...
                            <span class="tx-11 tx-roboto tx-white-6">{{$yesSale}}Rs yesterday</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
                ...
                <div class="bg-br-primary rounded overflow-hidden">
                    <div class="pd-25 d-flex align-items-center">
                        ...
                        <div class="mg-l-20">
                            ...
                            <span class="tx-11 tx-roboto tx-white-6">In {{\Carbon\Carbon::now()->monthName}}</span>
                        </div>
                    </div>
                </div>
            </div><!-- col-3 -->
        ...
        <div class="row mg-t-20">
            <div class="col-md-8">
                <div class="card pd-0 bd-0 shadow-base">
                    <div class="pd-x-30 pd-t-30 pd-b-15">
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">This Months Admission
                                    Progress
                                </h6>
                ...
                <div class="card bd-0 shadow-base pd-30 mg-t-20">
                    <div class="d-flex align-items-center justify-content-between mg-b-30">
                        <div>
                            <h6 class="tx-13 tx-uppercase tx-inverse tx-semibold tx-spacing-1">Upcoming Recoveries of
                                Students</h6>
                            <p class="mg-b-0"><i class="icon ion-calendar mg-r-5"></i>
                                From
