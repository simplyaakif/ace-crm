<?php
    ...
    class QueryTb extends Table {
        ...
        public function query()
        {
            ...
            queries.id as "dtRowId", q_name,q_contact,q_email,q_address,queries.created_at,q_session_type,q_interaction_type,q_preferred_timings,q_dealt_by,c_title,q_is_converted,q_remarks,courses.id as "coursesId"
